...
export type LogActionType =
    ...
    | 'INVITACION_ENVIADA' | 'INVITACION_REENVIADA' | 'INVITACION_ACEPTADA' | 'INVITACION_EXPIRADA_ELIMINADA'
    // Solicitud consolidada
    | 'SOLICITUD_CONSOLIDADA_SELLADA' | 'SOLICITUD_CONSOLIDADA_PDF_GENERADO' | 'SOLICITUD_CONSOLIDADA_PDF_ERROR'
    // Feedback
    | 'FEEDBACK_ENVIADO';
