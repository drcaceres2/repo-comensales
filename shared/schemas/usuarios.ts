...
export const userProfileSchema = z.object({
    ...
    numeroDeRopa: z.string().min(1).max(10).optional(),
    habitacion: z.string().min(1).max(10).optional(),
    universidad: z.string().min(2).max(150).optional(),
    ...
    fechaCreacion: z.number().nullable().optional(),
    ultimaActualizacion: z.number().nullable().optional(),
