...
export default function ContabilidadReporteCostosPage({ params }: { params: Promise<{ residenciaId: string }> }) {
  const unwrappedParams = React.use(params);
  const residenciaId = unwrappedParams.residenciaId;
  
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">Reporte de Costos</h1>
      <p>Residencia ID: {residenciaId}</p>
