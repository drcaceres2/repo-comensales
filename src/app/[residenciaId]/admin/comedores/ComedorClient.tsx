...
import { type ResultadoAcceso } from '@/lib/acceso-privilegiado';
...
interface ComedorClientProps {
    resultadoAcceso: ResultadoAcceso;
}

export default function ComedorClient({ resultadoAcceso }: ComedorClientProps) {
    ...
    }, [residenciaId, usuarioId, t, toast, zonaHoraria, roles, resultadoAcceso]);
