...
const DialogContent = (
  { className, children, description, ...props }: DialogContentProps
) => {
  const descriptionId = React.useId()
  const providedAria = (props as any)["aria-describedby"];
  const ariaDescribedBy = providedAria ?? descriptionId
  ...
  return (
    <DialogPortal>
      ...
      >
        {children}
        <DialogPrimitive.Description id={descriptionId} className={cn("sr-only")}>
          {description ?? ''}
