...
export const revocarAsistenteProxy = onCall(
    ...
    async (request) => {
        ...
        // Simplificamos la comprobación: solo un admin o director puede revocar.
        // Una lógica más compleja podría permitir a un asistente con 'gestionAsistentes' hacerlo.
        ...
        try {
            ...
            // 4. Registro de la acción (auditoría)
            await logAction(
                { uid: callerInfo.uid, token: callerInfo.claims },
                {
